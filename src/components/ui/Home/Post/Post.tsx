    ...
    return (
        <div className={styles.post}>
            <div className={styles.header}>
                {
                    info.updateStatus
                        ? <input type="text" value={info.titleUpdate}
                                 onChange={e => functions.setTitleUpdate(e.target.value)}/>
                        : <h2>{title}</h2>
                }
                <div className={styles.actions}>
                    <svg onClick={() => functions.handleClickDelete()} className={styles.icon}
                    ...
                    {
                        info.updateStatus
                            ? <svg onClick={() => functions.handleClickUpdate()} className={styles.icon}
                                   xmlns="http://www.w3.org/2000/svg"
                            ...
                            : <svg onClick={() => functions.setUpdateStatus(text)} className={styles.icon}
            ...
            </div>
            {
                info.updateStatus
                    ...
                    : <div dangerouslySetInnerHTML={{__html: bodyHTML || text}}/>
            }
        </div>
    );
};
